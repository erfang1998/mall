...
/**
 * 抽出sql语句查询条件，放入一个类中整理，
 * mysql配置文件抽出一个where语句模板，使用PmsBrandExample作为输入
 * Create by zy on 2020/1/6
 **/
public class PmsBrandExample {
    protected String orderByClause; //sql查询结果排序条件

    protected boolean distinct; //sql查询是否添加distinct关键字
    ...
    protected abstract static class GeneratedCriteria{
        ...
        protected void addCriterion(String condition, Object value, String property){
            if (value == null) {
                throw new RuntimeException("Value for "+property + "connot be null");
            }
        ...
        protected void addCriterion(String condition,Object value1, Object value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("between values for " + property + "cannnot be null");
            }
